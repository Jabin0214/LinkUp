...
namespace backend.Migrations
{
    ...
    [Migration("20250716003222_OptimizeSkillBoardStructure")]
    partial class OptimizeSkillBoardStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.SkillBoardItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SkillBoardId", "Type", "Order");

                    b.ToTable("SkillBoardItems", t =>
                        {
                            t.HasCheckConstraint("CK_SkillBoardItem_LinkUrl", "(Type = 'link' AND Url IS NOT NULL) OR Type != 'link'");

                            t.HasCheckConstraint("CK_SkillBoardItem_SkillLevel", "(Type = 'skill' AND Level IS NOT NULL) OR Type != 'skill'");
            ...
            modelBuilder.Entity("Models.SkillBoard", b =>
                {
                    b.HasOne("Models.User", "User")
                        .WithOne("SkillBoard")
                        .HasForeignKey("Models.SkillBoard", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
